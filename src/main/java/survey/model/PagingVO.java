...
public class PagingVO {
	    ...
	    public PagingVO(int pageSize, int firstPageNo, int prevPageNo, int startPageNo, int pageNo, int endPageNo,
				int nextPageNo, int finalPageNo, int totalCount, int startLimit) {
			super();
